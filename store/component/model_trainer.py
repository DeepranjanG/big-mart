...
from store.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from store.entity.config_entity import ModelTrainerConfig
from store.util.util import load_numpy_array_data,save_object,load_object
from store.entity.model_factory import MetricInfoArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            data_model = storeEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
